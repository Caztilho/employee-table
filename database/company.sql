...
CREATE TABLE `perfil_funcionario` (
  ...
  CONSTRAINT `perfil_funcionario_ibfk_1` FOREIGN KEY (`funcionario_id`) REFERENCES `funcionarios` (`id`) ON DELETE CASCADE
...
LOCK TABLES `perfil_funcionario` WRITE;
/*!40000 ALTER TABLE `perfil_funcionario` DISABLE KEYS */;
/*!40000 ALTER TABLE `perfil_funcionario` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-02-10 16:46:26
